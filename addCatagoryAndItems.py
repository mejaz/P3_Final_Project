...
catagory1 = session.query(Catagory).filter_by(catagory_name='Soccer').one()
...
catagory2 = session.query(Catagory).filter_by(catagory_name='Baseketball').one()
...
catagory7 = session.query(Catagory).filter_by(catagory_name='Foosball').one()
...
catagory8 = session.query(Catagory).filter_by(catagory_name='Skating').one()
